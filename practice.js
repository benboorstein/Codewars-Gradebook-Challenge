...
avgGrade(calcScoresMean(listOfScores))
...
avgGrade([63, 81, 97, 20, 45, 68, 94, 91, 99])
...
function avgGrade(listOfScores) {
    ...
    for (let i = 0; i < listOfScores.length; i++) { // FYI: Don't use for loops for iterating through arrays. The much cleaner alternative is shown in the "Fifth version" above.
